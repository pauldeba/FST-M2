...
public class Activity_2_API {
    ...
    public void addNewUserFromFile() throws IOException {
        // Import JSON file
        FileInputStream inputJSON = new FileInputStream("src/com/Activity/userinfo.json");
    ...
    public void getUserInfo() {
        ...
        File outputJSON = new File("src//com/Activity/userGETResponse.json");
